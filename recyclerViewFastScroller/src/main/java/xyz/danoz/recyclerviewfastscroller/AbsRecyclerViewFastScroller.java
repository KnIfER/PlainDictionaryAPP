...
public abstract class AbsRecyclerViewFastScroller extends FrameLayout implements RecyclerViewScroller {
    ...
    protected final View mBar; public View GGmBar() {return mBar;}
    /** The handle that signifies the user's progress in the list */
    protected final View mHandle; public View GGmHandle() {return mHandle;}
    
    protected final View mFakeRoot; public View GGmFakeRoot() {return mFakeRoot;}
    ...
    */
    ...
    public AbsRecyclerViewFastScroller(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            mFakeRoot = findViewById(R.id.froot);
    ...
    public void setConservativeScroll(boolean val) {
    	if(val)
    		scrollMode=1;
    	else
    		scrollMode=0;
