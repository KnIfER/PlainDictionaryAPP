...
# v7.9
- NEW -- 输入框"繁简转换"：可固定按钮至右上方菜单栏。 
- NEW -- 搜索工具栏 ：可隐藏图标。
- NEW -- 内容页：允许自定义标题栏高度，默认值45。
- FIX -- 修复弹出视图后，自定义工具栏相互干扰的BUG。 -- 修复不显示后，返回键仍在作用的BUG。

# v7.8.5
- FIX -- 词典管理器：进入后提示删除同名记录。
- NEW -- 长按返回键：在各个内容页面，长按弹出“更多菜单”，方便单手导航操作。
- FIX -- 修复滑动BUG。
