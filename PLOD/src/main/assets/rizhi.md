...
# v8.3.1
- NEW -- 优化 网页版多页面的“页面设置”入口（设置页面默认折叠方式等）：在多内容页面上长按词典标题、点击右上角“…”按钮、长按右下角上下切换按钮、从底部工具栏的宫格菜单进入。
- NEW -- 优化 沉浸滚动处理方式，将“隐藏工具栏”的过程“隐藏”在惯性滑动的动画里，更流畅。只对单内容页面和网页版多页面生效（旧版多视图多页面由于嵌套滚动难于处理）。
- FIX -- 修复 上次“修改默认值”造成部分设置无法开启的问题。
...
# v8.2.1
- NEW -- 新增 全局样式文件 PLOD/plaindict.css 如存在将加载进内容页面，可以用来调整全局字体。
- FIX -- 修复 词典同名css文件的加载。
- FIX -- 修复 字体字体库目录内的字体加载。

# v8.2
- NEW -- 点击翻译 : 允许自定义工具栏
- FIX -- 点击翻译 : 优化上下切换词典
- FIX -- 页面笔记 : 修复entry跳转后的笔记不显示


# v8.1
- NEW -- 内容页标题栏 ： 新增全局设置，在APP设置中可修改默认值，默认未勾选，从背景色推导。
- FIX -- 词典管理器“全部文件” ： 修复删除记录后：折叠文件夹不能展开、排序混乱、列表位置混乱的问题。
- NEW -- 词典管理器“文件夹排序” ： 新增简易拼音排序规则：文件夹内，汉字名称排在前，按常见汉字拼音的首字母排序。
- NEW -- 词典管理器“网络词典” ： 一并显示用户添加的网络词典。


# v8.0.1
- NEW -- 底部工具栏：新增“页面查找”按钮
- FIX -- 自动构词：修复BUG
- FIX -- 词典管理器：修复“全部词典”文件夹管理的诸多问题。
- FIX -- 词典管理上下文：使用“移至顶部”、“移至底部”后，可返回列表滚动位置
- FIX -- 单词上下文：修复弹出内容页面，在单词分享、发音时获取了错误的单词
 
# v8.0
- NEW -- 自动构词 : 联合搜索也使用自动构词库，自动去除单词后缀。
- FIX -- 笔记附注 ： 可以点击笔记气泡，修改或查看笔记内容
- FIX -- 兼容性 ： 兼容至安卓K，十年前的旧设备也可以
- FIX -- 夜间模式 ： 修复切换动画
- NEW -- 预览单词导图 ： 预览节点移动，画布缩放。预览期间数据不保存。
