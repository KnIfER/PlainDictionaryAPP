...
# v8.5
- 修复双引号全文搜索中不能使用通配符的局限。（搜索引擎的通配符只能用在词末，双引号内通配符目前只对英文有效）
- 调整浮动搜索菜单项
- “查看剪贴板”页面可记笔记
...
- 新增扩展：复制搜索、搜索+按钮，安装后增强文本选择菜单的功能。

# v8.4.2
- 新增历史记录全选、多行复制功能。

# v8.4.1
- 新增查看剪贴板：（右上菜单）可在内容页面查看剪贴板。
- 优化标题栏：显示箭头图标指示展开折叠状态。
- 修复标题栏：修复词典图标不显示。
- 修复其他BUG。
...
- 长按链接：可选择/复制链接文本、在本页打开、弹窗打开等。
- 点击翻译：长按返回按钮、标题栏、收藏按钮、发音按钮触发更多功能。
- 资源加载：（词典设置）设置是否加载词典同名css、是否允许从同目录加载文件资源。
