...
# v7.8.3
- FIX 修复词典管理器 -- 搜索界面等BUG

# v7.8.2
- NEW -- 改进**返回键** ： 记忆词典折叠状态、恢复滚动位置。
- NEW -- 新增“…”按钮，为内容页提供**更多菜单**。
- 改善黑暗模式下，文本菜单的背景色。 
...
# v7.7
## 主题更新
- 更新白色皮肤（主题色/背景色可设为明亮的颜色）。
- 允许自定义前景色（界面文本与图标的颜色）。
- 允许自定义水波纹颜色。

## 修复
- 修复页内搜索，不显示底部词典名称生效
- 浮动搜索以后再修复，优先完成主界面+小窗模式

# v7.6.1
- 修复词典管理器剪贴板不刷新，长按弹出更多操作。
- 移除动态库
