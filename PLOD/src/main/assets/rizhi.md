# 公告
- 可在APP内部访问在线应用社区“DoDo”或“贴吧”，可在侧滑抽屉“关于”页面中查看。
- DoDo群网址 ：https://www.imdodo.com/channel/157568/889301 。我会定时查看，整理内容。
- chrome 扩展“无限书签”制作中

# v 6.8
- 上下翻动“翻译当前页面”对话框（从右上角菜单按钮打开），新增页面内单字级繁简转换功能（仅供参考）。
...
### 3.优化“点击翻译”、新增“快速翻译栏”
- 启用“浏览选项”-“文本工具”按钮后，在按钮旁边新增横向的在线翻译词典列表——“快速翻译栏”，可快速翻译文本选择。预置添加四种在线翻译站点，合称“百彩必有译”，实现翻译自由。
- 点译自动去单词后缀（s/'s/es/ing/ed/er/est），猜测单词原型。
- “点击翻译”定位字符更精确。可为中文开启“大内存取词”模式（默认开启，可取得词组而非单字，需要分析整段文本）。
