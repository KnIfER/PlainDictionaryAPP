...
(function(){
    ...
    /**/} else {
        ...
        style.setAttribute('href', 'MdbR/settings.css');
    ...
    window.SettingsGetDialogHolder = getDialogHolder;
    window.SettingsShowDialog = showDialog;
    window.SettingsHideDialog = hideDialog;
})();