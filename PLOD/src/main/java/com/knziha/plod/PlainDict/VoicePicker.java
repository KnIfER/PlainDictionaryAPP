...
public class VoicePicker extends DialogFragment
{
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		if(GlobalOptions.isDark) {
			try {
				Object Scrollbar = a.ScrollCacheField.get(mListView);
...
//				vh.text.setBackground(null);
			...
			if(vcTmp instanceof Voicemy) {//目录
				...
				vh.subtext.setText(MainProgram.getCountryFlag(new StringBuilder(), locale.getCountry())+locale.getDisplayCountry()+vcTmp.getName());
