...
import com.knziha.plod.dictsmanager.dict_manager_activity.transferRunnable;
    ...
    private class MyAdapter extends ArrayAdapter<String> {
      ...
      public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(getItem(position).equals(LastSelectedPlan)) {
        	...
        	((TextView)v.findViewById(R.id.text)).setTextColor(a.opt.getInDarkMode()?Color.WHITE:Color.BLACK);
