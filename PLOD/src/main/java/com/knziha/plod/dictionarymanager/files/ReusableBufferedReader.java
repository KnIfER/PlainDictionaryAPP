 ...
 * therefore advisable to wrap a ReusableBufferedReader around any Reader whose read()
 * operations may be costly, such as FileReaders and InputStreamReaders.  For
 * example,
 *
 * <pre>
 * ReusableBufferedReader in
 *   = new ReusableBufferedReader(new FileReader("foo.in"));
 * </pre>
 *
 ...
 * replacing each DataInputStream with an appropriate ReusableBufferedReader.
 *
 * @see java.io.BufferedReader Mod2020 make memory reusable. Love java.
 * @see FileReader
...
public class ReusableBufferedReader extends Reader {
     ...
     */
    public ReusableBufferedReader(Reader in, char[] _cb, int sz) {
        super(in);
        this.in = in;
		if(_cb==null){
			cb = new char[sz];
     ...
     * Thus redundant <code>ReusableBufferedReader</code>s will not copy data
     * unnecessarily.
     *
