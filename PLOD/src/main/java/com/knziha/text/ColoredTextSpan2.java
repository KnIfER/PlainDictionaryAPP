 ...
 */
public class ColoredTextSpan2 extends UnderlineSpan
        implements UpdateAppearance {
    public int mColor;
    public int type;
    public float thickness;

    public ColoredTextSpan2(@ColorInt int mColor_) {
        super();
        init();
        thickness = 8.f;
        mColor=mColor_;
    ...
    public ColoredTextSpan2(@ColorInt int mColor_, float thickness_, int type_) {
        super();
        init();
        mColor = mColor_;
